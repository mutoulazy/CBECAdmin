...
<head>
    ...
    <link rel="stylesheet" href="${ctx!}/assets/skins/square/square.css" />
    <link rel="stylesheet" href="${ctx!}/assets/skins/toastr-master/toastr.css" />
</head>
<style>
    #back{
    ...
    <#list allTestPaper as item>
        <div class="col-xs-4">
            <div class="box">
                ...
                <h4 class="time">时间 : <span class="badge" style="background: grey; font-size: 15px">60</span> 分钟</h4>
                <div class="clearfix"></div>
                <button class="btn btn-info center-block" onclick="select(${item.id})">选择题目考试</button>
