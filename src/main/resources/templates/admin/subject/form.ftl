                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/subject/edit">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">上级专业：</label>
                            <div class="col-sm-8">
                                <select name="parent.id" class="form-control">
                                <#list list as r>
                                    <option value="${r.id}" <#if subject.parent.id == r.id>selected="selected"</#if>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="name" name="name" class="form-control" type="text" value="${subject.name}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="sort" name="sort" class="form-control" value="${subject.sort}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="description" name="description" class="form-control" value="${subject.description}">
                            </div>
                        </div>
                        <div class="form-group">
