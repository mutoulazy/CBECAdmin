...
<script>
        ...
        $("#table_list").bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                    ...
                    operateHtml = operateHtml + '<@shiro.hasPermission name="system:role:grant"><button class="btn btn-info btn-xs" type="button" onclick="grant(\''+row.id+'\')"><i class="fa fa-arrows"></i>&nbsp;分配题目</button></@shiro.hasPermission>';
                    return operateHtml;
                }
            }]
        });
    ...
    function edit(id){
        layer.open({
            ...
            shade: false,
            area: ['893px', '600px'],
            content: '${ctx!}/admin/testpaper/edit/' + id,
            end: function(index){
    ...
    function add(){
        layer.open({
            ...
            shade: false,
            area: ['893px', '600px'],
            content: '${ctx!}/admin/testpaper/add',
            end: function(index){
                $('#table_list').bootstrapTable("refresh");
            }
        });
    ...
    function grant(id){
        layer.open({
            ...
            shade: false,
            area: ['893px', '600px'],
            content: '${ctx!}/admin/testpaper/grant/'  + id,
            end: function(index){
                $('#table_list').bootstrapTable("refresh");
            }
        });
    ...
    function del(id){
        layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "${ctx!}/admin/testpaper/delete/" + id,
